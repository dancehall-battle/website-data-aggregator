...
const {setPostfix} = require("./utils");
...
module.exports = async () => {
  console.log('Getting rankings for countries (home/away)...');
  console.log('Getting id for countries (home/away)...');
  const id = await getCountryHomeAwayID();
  console.log(`id is ${id}`);
  console.log('Getting id for countries (home/away) done.');

  const countryHomeAway = await getCountryRankingByID(id);
  console.log('Getting rankings for countries (home/away) done.');
